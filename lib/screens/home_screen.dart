        ...
        children: [
          _isLoading
              ...
              : _problems.isEmpty
                  ...
                  : ListView.builder(
                      padding: const EdgeInsets.fromLTRB(16, 16, 16, 150), // Add padding to bottom
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Platform: ${_getPlatform()}', style: const TextStyle(color: Colors.white)),
                  Text('Week Start (KST): $_currentWeekStart', style: const TextStyle(color: Colors.white)),
                  Text('Problems Loaded: ${_problems.length}', style: const TextStyle(color: Colors.white)),
                  Text('Problem IDs: ${_problems.map((p) => p.id).toList()}', style: const TextStyle(color: Colors.white, fontSize: 10)),
                ],
              ),
            ),
          ),
