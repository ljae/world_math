...
''',
        question: '모델 B가 모델 A보다 총비용 측면에서 유리해지는 시점은 몇 년 후입니까? (소수점 첫째 자리에서 올림)',
        choices: ['① 18년', '② 20년', '③ 22년', '④ 24년', '⑤ 26년'],
        correctAnswer: '3',
        explanation: r'''
### 📝 정답 및 풀이
...
''',
        ...
        mathTopic: '일차방정식과 기회비용 (중학교 2학년 ~ 고등학교 수학 I)',
        economicTheme: '자동차 총소유비용(TCO), 기회비용, 손익분기점',
      ),
      Problem(
        id: 'p_20251118', // Tue
...
매도가 - 취득가 - 비용 - 세금 - 이자
''',
        question: r'보유 기간 1.5년 시점의 순수익(A)과 2.5년 시점의 순수익(B)의 차이($B-A$)는 얼마입니까?',
        choices: ['① 4.886억 원', '② 5.386억 원', '③ 5.886억 원', '④ 6.386억 원', '⑤ 6.886억 원'],
        correctAnswer: '3',
        explanation: r'''
### 📝 정답 및 풀이
...
''',
        ...
        mathTopic: '이차함수와 구간별 함수 (고등학교 수학 I)',
        economicTheme: '양도소득세 중과세, 보유 기간별 세율, \'똘똘한 한 채\' 전략',
      ),
...
''',
        question: '맥북 프로 100대를 수입할 때, 환율 1,500원 돌파 시(실질실효환율 86.59) 9월 말(실질실효환율 90.53) 대비 총 수입 원가는 얼마나 증가합니까?',
        choices: ['① 약 378만 원', '② 약 468만 원', '③ 약 558만 원', '④ 약 648만 원', '⑤ 약 738만 원'],
        correctAnswer: '2',
        explanation: r'''
### 📝 정답 및 풀이
...
''',
        ...
        mathTopic: '일차함수와 함숫값 계산 (중학교 1학년 ~ 고등학교 수학 I)',
        economicTheme: '실질실효환율(REER), 환율 변동, 수입 원가',
      ),
      Problem(
        id: 'p_20251120', // Thu
...
''',
        question: r'''조정된 '새로운 난이도'와 조정 직후 김 씨의 '예상 일일 수익'으로 가장 적절한 조합을 선택하세요.
(소수점 둘째 자리 반올림)''',
        choices: ['① 116.67 T, 17,140원', '② 116.67 T, 23,330원', '③ 85.71 T, 17,140원', '④ 85.71 T, 23,330원', '⑤ 100.00 T, 20,000원'],
        correctAnswer: '1',
        explanation: r'''
### 📝 정답 및 풀이
...
''',
        ...
        mathTopic: '비례식과 역비례 관계 (중학교 2학년)',
        economicTheme: '암호화폐 채굴 난이도(Difficulty), 작업 증명(PoW), 수익성',
      ),
      Problem(
        id: 'p_20251121', // Fri
...
''',
        question: '이 투자의 (1) 세전 시가배당률(%)과 (2) 세후 실제 수령하는 총 배당금액(100주 기준)으로 가장 적절한 조합을 선택하세요.',
        choices: ['① 7.33%, 930,600원', '② 7.33%, 1,100,000원', '③ 6.50%, 930,600원', '④ 8.50%, 1,000,000원', '⑤ 5.50%, 850,000원'],
        correctAnswer: '1',
        explanation: r'''
### 📝 정답 및 풀이
...
''',
        ...
        mathTopic: '백분율 계산과 세금 공제 (중학교 1학년)',
        economicTheme: '주주환원 정책, 배당수익률, 배당소득세',
      ),
      Problem(
        id: 'p_20251122',
...
2) 분리과세 적용 시: 배당소득 × 25%
''',
        question: '박 씨가 분리과세를 선택함으로써 절감하는 세금은 얼마이며, 세후 실제 수령액은 얼마입니까?',
        choices: ['① 세금 절감: 270만 원, 수령액: 1,500만 원', '② 세금 절감: 270만 원, 수령액: 1,730만 원', '③ 세금 절감: 230만 원, 수령액: 1,500만 원', '④ 세금 절감: 230만 원, 수령액: 1,770만 원', '⑤ 세금 절감: 200만 원, 수령액: 1,800만 원'],
        correctAnswer: '1',
        explanation: r'''
### 📝 정답 및 풀이
...
''',
        ...
        mathTopic: '백분율 계산과 세금 비교 (중학교 1학년 ~ 고등학교 수학 I)',
        economicTheme: '배당소득세, 종합과세 vs 분리과세, 실질 수익률',
      ),
      Problem(
...
''',
        question: '현대차그룹이 이 부지를 보유함으로써 얻은 (1) 총 평가차익(조 원 단위)과 (2) 11년간 연평균 수익률(복리 기준)로 가장 적절한 조합을 고르시오. (단, 현재 가치는 22조 6,477억 원으로 계산)',
        choices: ['① 약 10.5조 원, 약 6.5%', '② 약 11.5조 원, 약 7.0%', '③ 약 12.1조 원, 약 7.3%', '④ 약 12.1조 원, 약 7.5%', '⑤ 약 13.0조 원, 약 8.0%'],
        correctAnswer: '3',
        explanation: r'''
### 📝 정답 및 풀이
...
''',
        ...
        mathTopic: '백분율과 수익률 계산 (중학교 1학년 ~ 고등학교 수학 I)',
        economicTheme: '부동산 투자, 장기 투자 수익률, 복리 효과',
      ),
      Problem(
...
''',
        question: '론스타가 스타타워 투자를 통해 얻은 (1) 달러 기준 수익금액(억달러 단위, 소수점 첫째자리)과 (2) 부동산 시세 차익 2,510억 원 외에 환율 변동으로 추가로 얻은 차익을 원화 금액으로 가장 적절한 조합을 고르시오.',
        choices: ['① 약 2.5억 달러, 약 600억 원', '② 약 2.6억 달러, 약 800억 원', '③ 약 2.7억 달러, 약 900억 원', '④ 약 2.8억 달러, 약 1,000억 원', '⑤ 약 3.0억 달러, 약 1,200억 원'],
        correctAnswer: '2',
        explanation: r'''
### 📝 정답 및 풀이
...
''',
        ...
        mathTopic: '환율 계산과 수익률 (중학교 2학년 ~ 고등학교 수학 I)',
        economicTheme: '외환 투자, 환율 변동, 국제 펀드 투자 전략',
      ),
    ];
